                  ...
                  <div class="row mbm">
                     <div class="col-lg-12">
                        ...
                        <div class="portlet-header pam mbn">
                           <div class="caption"><?php echo e(trans('message.banner')); ?></div>
                           <div class="actions">
                              <a href="<?php echo e(url(key($listing))); ?>" class="btn btn-info btn-sm">
                                 <i class="fa fa-plus"></i>&nbsp;
                                 <?php echo e(trans('message.addnewbanner')); ?>
                           ...
                           <table id="table_id" class="table table-hover table-striped table-bordered table-advanced tablesorter display">
                              ...
                              <?php if($banner->count()>0): ?>
                                 ...
                                 <tr id="hide_<?php echo e($row->id); ?>">
                                       ...
                                       <td>
                                          <a class="btn btn-default btn-xs edit" href="<?php echo e(URL::to('editBanner',[encodeParam($row->id) ])); ?>" title="Edit Banner"> <i class="fa fa-edit"></i></a>
                                          <button type="button" class="btn btn-default btn-xs confirmDelete" data-siteurl ="<?php echo e(url('/')); ?>" data-tablename="banners" data-record-id="<?php echo e($row->id); ?>" data-record-title="Are you sure you want to delete this Banner ?" data-toggle="modal" data-target="modal-confirm" data-succuss="Banner deleted successfully">
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\manvendra\Ampps\www\vectorindia\resources\views/admin/banner/index.blade.php ENDPATH**/ ?>