	 ...
	 <div class="col-lg-12">
					<div class="panel panel-blue">
					   ...
					   <div class="panel-body pan">
							 <?php echo e(Form::open(['method'=>'post','url'=>'updateLatestnews','files'=>'true','class'=>'form-horizontal','role'=>'form'])); ?>

							 <?php echo e(Form::hidden('id', @$newsDetails['id'], array('name'=>'id'))); ?>
							 ...
							 <div class="form-body pal">
										<div class="form-group <?php echo e($errors->has('heading') ? 'has-error' : ''); ?>">
											...
											<?php echo e(Form::text('heading', $newsDetails['heading'], array('class' => 'form-control','placeholder'=> trans('message.heading'), 'rows'=>"4" ,'cols'=>"50"))); ?>
											...
											<div class="col-md-9">
											<div class="input-icon"><i class="fa fa-user"></i>
											<?php echo e(Form::text('sub_heading', $newsDetails['sub_heading'], array('class' => 'form-control','placeholder'=> trans('message.sub_heading'), 'rows'=>"4" ,'cols'=>"50"))); ?>
											...
											<div class="col-md-9">
											<div class="input-icon"><i class="fa fa-user"></i>
											<?php echo e(Form::textarea('description', $newsDetails['description'], array('class' => 'form-control','placeholder'=> trans('message.description'),'required'=>true,'type'=>'email'))); ?>
											...
											<div class="col-md-9">
											<div class="input-icon"><i class="fa fa-user"></i>
											<?php echo e(Form::text('written_by', $newsDetails['written_by'], array('class' => 'form-control','placeholder'=> trans('message.writtenby'),'required'=>true))); ?>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\manvendra\Ampps\www\vectorindia\resources\views/admin/latestnews/edit.blade.php ENDPATH**/ ?>