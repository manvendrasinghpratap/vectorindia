  ...
  <div class="row">
	 <div class="col-lg-12">
					<div class="panel panel-blue">
					   <div class="panel-heading"><?php echo e(trans('message.addnewbanner')); ?> </div>
					   <div class="panel-body pan">
						  <?php echo e(Form::open(['method'=>'post','url'=>'storenewBanner','files'=>'true','class'=>'form-horizontal','role'=>'form'])); ?>

								 <div class="form-body pal">
											<div class="form-group <?php echo e($errors->has('sub_heading1') ? 'has-error' : ''); ?>">
											<label for="heading" class="col-md-3 control-label"><?php echo e(trans('message.sub_heading1')); ?><span class='require'>*</span></label>
												<div class="col-md-9">
													<div class="input-icon"><i class="fa fa-user"></i>
													<?php echo e(Form::text('sub_heading', '', array('class' => 'form-control','placeholder'=> trans('message.sub_heading'), 'rows'=>"4" ,'cols'=>"50"))); ?>
											...
											<div class="form-group <?php echo e($errors->has('mainheading') ? 'has-error' : ''); ?>">
												...
												<div class="col-md-9">
													<div class="input-icon"><i class="fa fa-user"></i>
														<?php echo e(Form::text('heading', '', array('class' => 'form-control','placeholder'=> trans('message.mainheading'), 'rows'=>"4" ,'cols'=>"50"))); ?>
											...
											<label for="heading" class="col-md-3 control-label"><?php echo e(trans('message.sub_heading2')); ?><span class='require'>*</span></label>
												<div class="col-md-9">
													<div class="input-icon"><i class="fa fa-user"></i>
													<?php echo e(Form::text('sub_heading2', '', array('class' => 'form-control','placeholder'=> trans('message.sub_heading2'), 'rows'=>"4" ,'cols'=>"50"))); ?>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\manvendra\Ampps\www\vectorindia\resources\views/admin/banner/create.blade.php ENDPATH**/ ?>