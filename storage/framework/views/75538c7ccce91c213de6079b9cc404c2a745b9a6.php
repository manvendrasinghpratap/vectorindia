                           ...
                           <table id="table_id" class="table table-hover table-striped table-bordered table-advanced tablesorter display">
                              ...
                              <?php if($testimonial->count()>0): ?>
                                 ...
                                 <tr id="hide_<?php echo e($row->id); ?>">
                                       ...
                                       <td>
                                          <a class="btn btn-default btn-xs edit" href="<?php echo e(URL::to('edittestimonials',[encodeParam($row->id) ])); ?>" title="Edit News"> <i class="fa fa-edit"></i></a>
                                          <button type="button" class="btn btn-default btn-xs confirmDelete" data-siteurl ="<?php echo e(url('/')); ?>" data-tablename="testimonials" data-record-id="<?php echo e($row->id); ?>" data-record-title="Are you sure you want to delete this testimonial ?" data-toggle="modal" data-target="modal-confirm" data-succuss="Testimonial deleted successfully">
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\manvendra\Ampps\www\vectorindia\resources\views/admin/testimonial/index.blade.php ENDPATH**/ ?>