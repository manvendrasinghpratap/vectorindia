<?php $__env->startSection('section'); ?>
      ...
      <div class="row">
        <div class="col-12">
          <div class="page-hero-wrapper"><span style="display:none;" class="subtitle">EXLEON BUSINESS</span>
            <h2 class="title"><?php echo e($newsDetails->heading); ?></h2>
          </div>
        </div>
      </div>
    </div>
  ...
  <article>
    ...
    <?php elseif(file_exists('public/storage/'.$newsDetails->imagename)): ?>
      <?php @$imagename= $newsDetails->imagename; ?>
    <?php else: ?>
      <?php @$imagename = 'default.jpg'; ?>
    <?php endif; ?>
      ...
      <div class="row">
        <div class="col-12">
          <div class="article-wrapper article--blog">
            <figure class="article-figure"><img src="<?php echo e(url('public/storage/'.@$imagename)); ?>" alt="exleon">
              <div class="article-figure-icon"><i class="fas fa-lightbulb"></i></div>
            </figure>
            <div class="article-content-wrapper">
              <div class="article-content-main">
                <h2 class="title"><?php echo e($newsDetails->heading); ?></h2>
                <div class="article-content-details"><span><?php echo e($newsDetails->sub_heading); ?></span> <span>Post On : <?php echo e($newsDetails->created_at->format('Y-m-d')); ?></span></div>
                <p><?php echo e($newsDetails->description); ?></p>
              </div>
            </div>
          </div>
          <div class="row" >
...
<?php echo $__env->make('layouts.newdetail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vectorindia\resources\views/frontend/newdetail.blade.php ENDPATH**/ ?>