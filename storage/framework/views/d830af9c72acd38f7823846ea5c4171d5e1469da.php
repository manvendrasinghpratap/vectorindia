	 ...
	 <div class="col-lg-12">
					<div class="panel panel-blue">
					   ...
					   <div class="panel-body pan">
						  <?php echo e(Form::open(['method'=>'post','url'=>'storetestimonials','files'=>'true','class'=>'form-horizontal','role'=>'form'])); ?>
								 ...
								 <div class="form-body pal">
											...
											<div class="col-md-9">
											<div class="input-icon"><i class="fa fa-user"></i>
											<?php echo e(Form::text('written_by', '', array('class' => 'form-control','placeholder'=> trans('message.writtenby'),'required'=>true))); ?>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\manvendra\Ampps\www\vectorindia\resources\views/admin/testimonial/create.blade.php ENDPATH**/ ?>