  ...
  <div class="row">
	 <div class="col-lg-12">
					<div class="panel panel-blue">
					   <div class="panel-heading"><?php echo e(trans('message.addnewsponsor')); ?> </div>
					   <div class="panel-body pan">
						  <?php echo e(Form::open(['method'=>'post','url'=>'storesponsor','files'=>'true','class'=>'form-horizontal','role'=>'form'])); ?>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\manvendra\Ampps\www\vectorindia\resources\views/admin/sponsor/create.blade.php ENDPATH**/ ?>