jQuery(function ($) {
	...
	var App = {
		...
		initTestimonialTypeFull: function initTestimonialTypeFull() {
			var node = $(".testimonials-type-full .section-content .row");
			if (node) {
				node.slick({
					nextArrow:'<div class="slick-next"><i class="fas fa-chevron-right"></i></div>',
					prevArrow:'<div class="slick-prev"><i class="fas fa-chevron-left"></i></div>',
		...
		initHomeBrandsFull: function initHomeBrandsFull() {
			var node = $(".home-box-main .home-about-us-box .row");
			if (node) {
				node.slick({
					nextArrow:'<div class="slick-next"><img src="public/assets/img/comp-arrow-right.png" /></div>',
					prevArrow:'<div class="slick-prev"><img src="public/assets/img/comp-arrow-left.png" /></div>',
					dots: false, 
					arrows:true,
					autoplay: true,
					autoplaySpeed: 3000,
	...
	App.initTestimonialTypeFull();
	App.initHomeBrandsFull();
	App.initAppCarousel();
