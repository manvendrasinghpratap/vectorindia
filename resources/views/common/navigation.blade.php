          ...
          <div class="row">
            <div class="col-12">
              <div class="headbar-container">
                ...
                <div class="app-social-links-wrapper"><a class="app-social-link" href="skype:{{@$settings['skype']}}?call"><i class="fab fa-skype"></i></a><a class="app-social-link" href="{{@$settings['facebook']}}"><i class="fab fa-facebook-f"></i></a><a class="app-social-link" href="{{@$settings['googleplus']}}"><i class="fab fa-google-plus-g"></i></a><a class="app-social-link" href="{{@$settings['twitter']}}"><i class="fab fa-twitter"></i></a><a class="app-social-link" href="{{@$settings['vimeo']}}"><i class="fab fa-vimeo-v"></i></a><a class="app-social-link" href="{{@$settings['youtube']}}"><i class="fab fa-youtube"></i></a>
                </div>
              </div>
            </div>
          </div>
