          ...
          <div class="col-12">
            <div class="app-footer-wrapper">
              <div class="app-social-links-wrapper">
                <a class="app-social-link" href="skype:{{@$settings['skype']}}?call"><i class="fab fa-skype"></i></a>
                <a class="app-social-link" href="{{@$settings['facebook']}}"><i class="fab fa-facebook-f"></i></a>
