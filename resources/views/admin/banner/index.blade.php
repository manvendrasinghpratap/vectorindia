                  ...
                  <div class="row mbm">
                     <div class="col-lg-12">
                        ...
                        <div class="portlet-header pam mbn">
                           <div class="caption">{{trans('message.banner') }}</div>
                           <div class="actions">
                              <a href="{{ url(key($listing)) }}" class="btn btn-info btn-sm">
                                 <i class="fa fa-plus"></i>&nbsp;
                                 {{trans('message.addnewbanner') }}
                              </a>&nbsp;
                           </div>
                        </div>
                           ...
                           <table id="table_id" class="table table-hover table-striped table-bordered table-advanced tablesorter display">
                              ...
                              @if($banner->count()>0)
                                 ...
                                 <tr id="hide_{{ $row->id }}">
                                       ...
                                       <td>
                                          <a class="btn btn-default btn-xs edit" href="{{ URL::to('editBanner',[encodeParam($row->id) ])}}" title="Edit Banner"> <i class="fa fa-edit"></i></a>
                                          <button type="button" class="btn btn-default btn-xs confirmDelete" data-siteurl ="{{ url('/')}}" data-tablename="banners" data-record-id="{{ $row->id }}" data-record-title="Are you sure you want to delete this Banner ?" data-toggle="modal" data-target="modal-confirm" data-succuss="Banner deleted successfully">
